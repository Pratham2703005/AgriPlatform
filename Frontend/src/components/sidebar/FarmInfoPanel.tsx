...
export const FarmOverviewPanel: React.FC<FarmOverviewPanelProps> = ({
  ...
  return (
    <div className='space-y-3'>
      <div className='relative overflow-hidden rounded-xl border border-emerald-200 bg-gradient-to-br from-emerald-50 via-white to-lime-50 p-3.5 shadow-sm'>
        <div className='absolute -right-8 -top-8 h-20 w-20 rounded-full bg-emerald-200/40 blur-xl' />
        <div className='relative flex items-start justify-between gap-3'>
          <div className='min-w-0'>
            <div className='flex items-center gap-2.5'>
              <div className='h-10 w-10 p-2 rounded-xl border border-emerald-200 bg-emerald-100/90 flex items-center justify-center shadow-sm ml-0.5'>
              ...
              <div className='mt-1.5 text-[11px] leading-4 text-neutral-600'>
                ...
                {farm.description.length > DESCRIPTION_PREVIEW_CHARS && (
                  <button
                    ...
                    className='mt-1 inline-flex items-center text-[11px] font-semibold text-emerald-700 hover:text-emerald-900'
                  >
          ...
          <div className='flex flex-col items-end gap-1.5 min-w-[128px]'>
            {canEdit && (
              <div className='mb-0.5 flex items-center gap-1'>
                <Link
                  ...
                  className='inline-flex items-center rounded-md border border-neutral-200 bg-white px-2 py-1 text-[10px] font-semibold text-neutral-700 hover:bg-neutral-50'
                >
                ...
                <button
                  type='button'
                  onClick={onDelete}
                  className='inline-flex items-center rounded-md border border-red-200 bg-white px-2 py-1 text-[10px] font-semibold text-red-700 hover:bg-red-50'
                >
            ...
            <div className='w-full mt-0.5 space-y-1 text-[10px]'>
              <div className='flex items-center justify-between gap-2'>
                <span className='text-neutral-500'>Overall health</span>
                <span
                  className={`inline-flex items-center whitespace-nowrap rounded-full border px-2 py-0.5 text-[10px] font-semibold ${
              ...
              <div className='flex items-center justify-between gap-2'>
                ...
                <span
                  className={`inline-flex items-center gap-1 font-semibold ${priorityTextClass}`}
                >
                  <span
      ...
      <button
        ...
        className='w-full text-left rounded-xl border border-neutral-200 bg-white p-3.5 shadow-sm hover:shadow-md hover:-translate-y-[1px] transition-all duration-200'
      ...
      >
        ...
        <div>
          ...
          <div className='mt-2.5 inline-flex items-center text-[11px] font-semibold text-sky-700'>
            View NDVI Trends
