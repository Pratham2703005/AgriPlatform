...
import { Search, ExternalLink, Newspaper, ChevronLeft, ChevronRight } from 'lucide-react';
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1.5 mt-1 text-[10px] text-neutral-500">
                      ...
                      <span>•</span>
                      <span className="flex-shrink-0">{formatDate(item.publishedAt)}</span>
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between pt-2 border-t border-neutral-100">
          ...
          <span className="text-xs text-neutral-600">
            Page <span className="font-semibold text-neutral-900">{currentPage}</span> of {totalPages}
          </span>
          <button
